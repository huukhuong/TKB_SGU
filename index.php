...
<body>
    <div class="container py-5">
        ...
        <h4 class="text-center mt-2">Web còn một số lỗi nhỏ đối với những bạn có 2 buổi học từ tiết 11 trong tuần</h4>
        <h4 class="text-center">Nếu chức năng lưu ảnh bị lỗi vui lòng chụp màn hình thủ công</h4>
        <h5 class="text-center">Nhân sự thực hiện:</h5>
